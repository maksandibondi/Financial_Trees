...
%% Main program
[V,S,u,d] = price_s0_fixed_Condor(N,T,S0,K,r,sigma);
Initial_price = V(1,1);
...
h = 0.5;
V1 = price_s0_fixed_Condor(N,T,newS0+h,K,r,sigma);
V2 = price_s0_fixed_Condor(N,T,newS0-h,K,r,sigma);
V0 = price_s0_fixed_Condor(N,T,newS0,K,r,sigma);
...
S01 = 0:1:40;
for i = 1:size(S01,2);
    [V1,S1,u1,d1] = price_s0_fixed_Condor(N,T,S01(i),K,r,sigma);
